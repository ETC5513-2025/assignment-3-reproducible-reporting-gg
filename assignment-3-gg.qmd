...
Monash University is located in Melbourne and the courses of computer science are mainly in Clayton. The day-by-day living cost index is 72.8. This means with real-world data from [NUMBEO](https://www.numbeo.com/cost-of-living/in/New-York), which reports the average monthly living cost for single person (excluding rent) in New York City as USD 1,709.20 and in Melbourne as USD 1,244.30. It indicates that daily expenses such as food, transportation, and utilities in Melbourne are relatively manageable than major global cities.
