...
sapply(data[key_cols], function(col) class(col)[1])

```

The dataset provides the following cost components — tuition, rent, living-cost index, visa fees, and insurance — all standardized to U.S. dollars and expressed as 2025 USD values across global universities. We then filtered for the Master of Computer Science records, verified that each component was numeric, and removed any rows with missing values in those fields.
