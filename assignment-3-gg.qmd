...
The following figure compares the total estimated affordability ratio of applying a Master of Computer Science across selected universities
...
cost_data <- international_stu_cost |>
  ...
  mutate(AnnualLiving_Cost = ( Living_Cost_Index / 100 ) * 15000,
...
ratio_plot <- ggplot(cost_data_top, 
