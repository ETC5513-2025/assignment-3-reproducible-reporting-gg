...
All analyses and visualizations were performed in R using the **tidyverse** within a Quarto-driven workflow. Data import used **readr**, plotting was performed with **ggplot2**, and tables were generated using **knitr**. All code was version-controlled with Git, and the report was rendered to PDF using LaTeX.
